        ...
        <View style={styles.modal}>
          ...
          <View style={styles.header}>
            <View style={styles.iconContainer}>
              <Image source={require('../../assets/icons/star.png')} style={{width: 32, height: 32, tintColor: Colors.dark.primary}} />
            </View>
          ...
          >
            <Image source={require('../../assets/icons/files.png')} style={{width: 22, height: 22, tintColor: '#fff'}} />

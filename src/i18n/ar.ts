...
// ── NEW KEYS — paste these inside the `ar` object in src/i18n/ar.ts ──────────
  ...
  email_choose_title:       'كيف تريد المتابعة؟',
  email_choose_signin:      'تسجيل الدخول',
  email_choose_signin_sub:  'لدي حساب بالفعل',
  email_choose_signup:      'إنشاء حساب',
  email_choose_signup_sub:  'أنا جديد هنا',
  ...
  reset_link_sent_title:    'تم الإرسال',
  reset_link_sent_body:     'تم إرسال رابط إعادة تعيين كلمة المرور إلى بريدك الإلكتروني.',
  reset_send_failed:        'فشل الإرسال. حاول مرة أخرى.',
  btn_sign_in:               'تسجيل الدخول',
  btn_create_account:        'إنشاء حساب',
  btn_send_reset_link:       'إرسال رابط الاسترداد',
  link_create_account:       'إنشاء حساب جديد',
  link_forgot_password:      'نسيت كلمة المرور؟',
  link_back_to_signin:       'العودة لتسجيل الدخول',
  ...
  profile_name:            'الاسم',
  profile_name_placeholder: 'أدخل اسمك',
  profile_gender:          'الجنس',
  gender_male:             'ذكر',
  gender_female:           'أنثى',
  gender_other:            'آخر',
  profile_genres:          'الأنواع المفضلة',
  profile_genres_hint:     'اختر بعضاً منها لتخصيص التوصيات',
  profile_edit:            'تعديل الملف الشخصي',
  profile_save:            'حفظ',
  profile_saved:           'تم تحديث الملف الشخصي',
  profile_save_failed:     'فشل الحفظ. حاول مرة أخرى.',
  avatar_change:           'تغيير الصورة',
  avatar_uploading:        'جارٍ رفع الصورة…',
  avatar_upload_failed:    'فشل رفع الصورة. حاول مرة أخرى.',

 ...
 *
 * - Uses loadCategory() not getAllContentIndex()
 * - Pagination (30 items at a time)
 * - Filter modal with genre + year + sort
 * - RTL support
 * - Memoised and optimised for large lists
 */
...
// Hoisted sort helpers (work with ContentItem)
